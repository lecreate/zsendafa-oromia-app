            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($supplier->id); ?>">
                    ...
                    <td><?php echo e($supplier->address); ?>
                            ...
                            <?php if($supplier->city): ?><?php echo e(', '.$supplier->city); ?><?php endif; ?></td>
                    <td>
                        <div class="btn-group">
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
	       <p><?php echo e(trans('file.The correct column order is')); ?> (name*, image, company_name*, vat_number, email*, phone_number*, address*, city*) <?php echo e(trans('file.and you must follow this')); ?>.</p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cmms\resources\views/supplier/index.blade.php ENDPATH**/ ?>