                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                            <input type="hidden" class="product-batch-id" name="product_batch_id[]" value="<?php echo e($product_transfer->product_batch_id); ?>">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="">
                                            <label ><?php echo e(trans('file.transferor')); ?></label>
                                    ...
                                    <div class="col-md-6">
                                   <div class="form-group">
                                            <label ><?php echo e(trans('file.recipient')); ?></label>
                                            <textarea rows="5" class="form-control" name="transferor"></textarea>
                                        </div> 
                                    </div> 
                                </div> 
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cmms\resources\views/transfer/edit.blade.php ENDPATH**/ ?>