                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">  
                                   ...
                                   <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.mmhf')); ?>

                                            </label>
                                            <input type="text" name="mmhf" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.lmqgit')); ?>

                                            </label>
                                            <input type="text" name="lmqgit" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.lait')); ?>

                                            </label>
                                            <input type="text" name="lait" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.lndh')); ?>

                                            </label>
                                            <input type="text" name="lndh" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.myno')); ?>

                                            </label>
                                            <input type="text" name="myno" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.pdate')); ?>
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.mynt')); ?>

                                            </label>
                                            <input type="text" name="mynt" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                        <div class="form-group">
                                            <label>
                                ...
                                <div class="row">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label ><?php echo e(trans('file.pnotification')); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/purchase/create.blade.php ENDPATH**/ ?>