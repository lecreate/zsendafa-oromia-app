...
<script type="text/javascript">
    ...
    function deliveryDetails(delivery, barcode) {
        ...
        rows += '<tr><td>Recieved Refer</td><td>'+delivery[2]+'</td></tr>';
        rows += '<tr><td>Status</td><td>'+delivery[3]+'</td></tr>';
        rows += '<tr><td>Employee Name</td><td>'+delivery[5]+'</td></tr>';
        rows += '<tr><td>Address</td><td>'+delivery[7]+', '+delivery[8]+'</td></tr>';
        rows += '<tr><td>Phone Number</td><td>'+delivery[6]+'</td></tr>';
        rows += '<tr><td>Issue Information</td><td>'+delivery[9]+'</td></tr>';
        ...
        var htmlfooter = '<div class="col-md-4 form-group"><p>Authorized by Name and Signature: '+delivery[10]+'</p></div>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cmms\resources\views/delivery/index.blade.php ENDPATH**/ ?>