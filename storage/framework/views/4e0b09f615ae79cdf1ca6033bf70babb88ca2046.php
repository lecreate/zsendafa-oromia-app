            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Add US')); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" id="customer_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select employee...">
                                                <?php $deposit = []; ?>
                                 ...
                                 <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="biller_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Store Keeper...">
                                    ...
                                    <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.won')); ?>

                                            </label>
                                            <input type="text" name="won" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.assetout')); ?>

                                            </label>
                                            <input type="text" name="assetout" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.pinp')); ?>

                                            </label>
                                            <input type="text" name="pinp" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.myname')); ?>
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.dated')); ?>

                                            </label>
                                            <input type="dated" name="dated" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.issue')); ?>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        ...
                                        <div class="search-box input-group">
                                            ...
                                            <input type="text" name="product_code_name" id="lims_productcodeSearch" placeholder="Please type product serial and select..." class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <div class="">
                                            <label style="text-align: left;"><?php echo e(trans('file.Sale Note')); ?></label>
                                            <textarea rows="5" class="form-control" name="sale_note"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="text-align: center;"><?php echo e(trans('file.Staff No')); ?></label>
                                            <textarea rows="5" class="form-control" name="staff_note"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        <label style="text-align: center;"><?php echo e(trans('file.Notification')); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/sale/create.blade.php ENDPATH**/ ?>