                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <!-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label><?php echo e(trans('file.Product Model')); ?> *</strong> </label>
                                        <input type="text" name="model" class="form-control" id="name" aria-describedby="name" required>
                                        <span class="validation-msg" id="name-error"></span>
                                    </div>
                                </div> -->
                                <div class="col-md-4">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/product/create.blade.php ENDPATH**/ ?>