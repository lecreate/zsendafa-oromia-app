					...
					<div class="col-md-5 offset-md-3 mt-2">
						<div class="pie-chart">
							<?php
			                 ...
			                 ?>
					      	<canvas id="pieChart" data-color="<?php echo e($color); ?>" data-color_rgba="<?php echo e($color_rgba); ?>" data-price=<?php echo e($total_price); ?> data-cost=<?php echo e($total_cost); ?> width="10" height="10" data-label1="<?php echo e(trans('file.Stock Value by Price')); ?>" data-label2="<?php echo e(trans('file.Stock Value by Cost')); ?>"> </canvas>
					    </div>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cmms\resources\views/report/warehouse_stock.blade.php ENDPATH**/ ?>