        ...
        <table id="customer-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="<?php echo e($customer->id); ?>">
                    ...
                    <td><?php echo e($customer->address); ?>, <?php echo e($customer->city); ?></td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
           <p><?php echo e(trans('file.The correct column order is')); ?> (customer_group*, name*, company_name, email, phone_number*, address*, city*) <?php echo e(trans('file.and you must follow this')); ?>.</p>
            <div class="row">
                <div class="col-md-6">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/customer/index.blade.php ENDPATH**/ ?>