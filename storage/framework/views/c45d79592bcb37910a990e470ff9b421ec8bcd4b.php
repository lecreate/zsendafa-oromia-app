...
<section>
    <div class="container-fluid">
        ...
        <?php if(in_array("sales-add", $all_permission)): ?>
            <a href="<?php echo e(route('sales.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add US')); ?></a>&nbsp;
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    <div class="col-md-3">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i class="dripicons-print"></i> <?php echo e(trans('file.Print')); ?>

                         
                     </button>
                       <label>Moodela 22A/B</label> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.ask')); ?> *</label>
                        <p id="customer"></p>
                    </div>
                    <!-- <div class="col-md-6 form-group">
                    ...
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.doffice')); ?></label>
                        <textarea rows="3" name="doffice" class="form-control"></textarea>
                    </div> 
                    <div class="col-md-6 form-group">
                        <label> <?php echo e(trans('file.dname')); ?></label>
                        <textarea rows="3" name="dname" class="form-control"></textarea>
                    </div>
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.dwork')); ?></label>
                        <textarea rows="3" name="dwork" class="form-control"></textarea>
                    </div>
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.ask')); ?></label>
                        <!-- <textarea rows="3" name="doffice" class="form-control"></textarea> -->
...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        $("#sale-details input[name='sale_id']").val(sale[19]);

        var htmltext = '<strong><?php echo e(trans("file.Date")); ?>: </strong>'+sale[0]+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong ><?php echo e(trans("file.reference")); ?>: </strong>'+sale[1]+'<br><strong><?php echo e(trans("file.Warehouse")); ?>: </strong>'+sale[33]+'<br><strong><?php echo e(trans("file.Sale Status")); ?>: </strong>'+sale[8]+'<br><strong><?php echo e(trans("file.won")); ?>: </strong>'+sale[2]+'<br><strong><?php echo e(trans("file.assetout")); ?>: </strong>'+sale[3]+'<br><strong><?php echo e(trans("file.pinp")); ?>: </strong>'+sale[4]+'<br> <strong ><?php echo e(trans("file.myname")); ?> </strong>'+sale[5]+'&nbsp;<strong ><?php echo e(trans("file.dated")); ?> </strong>'+sale[6]+'&nbsp;<strong ><?php echo e(trans("file.issue")); ?> </strong>'+sale[7]+'&nbsp;<strong ><?php echo e(trans("file.sign")); ?> </strong></div><div class="row"><br><div class="col-md-6"><strong><?php echo e(trans("file.From")); ?>:</strong><br>'+sale[9]+'<br>'+sale[10]+'<br>'+sale[11]+'<br>'+sale[12]+'<br>'+sale[13]+'<br>'+sale[14]+'</div><div class="col-md-6"><div class="float-right"><strong><?php echo e(trans("file.To")); ?>:</strong><br>'+sale[15]+'<br>'+sale[16]+'<br>'+sale[17]+'<br>'+sale[18]+'</div></div></div>';
        $.get('sales/product_sale/' + sale[19], function(data){
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Sale Note")); ?></strong> <br>Maqaa:'+sale[29]+'<br> Mallatto:</p><p><strong><?php echo e(trans("file.Staff No")); ?></strong><br>Maqaa: '+sale[30]+'<br> Mallatto:</p><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+sale[31]+'<br>'+sale[32]+'<p><strong><?php echo e(trans("file.Notification")); ?></strong> ';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/sale/index.blade.php ENDPATH**/ ?>