...
class DeliveryController extends Controller
{
    ...
    public function create($id){
    	...
    	if($lims_delivery_data){
    		...
    		$delivery_data[] = $lims_delivery_data->doffice;
            $delivery_data[] = $lims_delivery_data->dname;
            $delivery_data[] = $lims_delivery_data->dwork;
    	}
    	else{
    		...
    		$delivery_data[] = ''; $delivery_data[] = ''; $delivery_data[] = ''; $delivery_data[] = '';
    	}        
    ...
    public function store(Request $request)
    {
        ...
        $delivery->doffice = $data['doffice'];
        $delivery->dname = $data['dname'];
        $delivery->dwork = $data['dwork'];
        // $delivery->ask = $data['ask'];
        $delivery->save();
    ...
    public function sendMail(Request $request)
    {
        ...
        if($lims_customer_data->email) {
            ...
            $mail_data['doffice'] = $lims_delivery_data->doffice;
            $mail_data['dname'] = $lims_delivery_data->dname;
            $mail_data['dwork'] = $lims_delivery_data->dwork;
            // $mail_data['ask'] = $lims_delivery_data->ask;
    ...
    public function edit($id)
    {
        ...
        $delivery_data[] = $lims_delivery_data->dname;
        $delivery_data[] = $lims_delivery_data->dwork;
        // $delivery_data[] = $lims_delivery_data->ask;
    	return $delivery_data;
    }
    ...
    public function update(Request $request)
    {
        ...
        if($lims_customer_data->email && $input['status'] != 1){
            ...
            $mail_data['doffice'] = $input['doffice'];
            $mail_data['dname'] = $input['dname'];
            $mail_data['dwork'] = $input['dwork'];
            try{
                Mail::send( 'mail.delivery_details', $mail_data, function( $message ) use ($mail_data)
                {
                    $message->to( $mail_data['email'] )->subject( 'Delivery Details' );
