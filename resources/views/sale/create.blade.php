                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6">
                                        <div class="">
                                            <label style="text-align: left;">{{trans('file.Sale Note')}}</label>
                                            <textarea rows="5" class="form-control" name="sale_note"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label style="text-align: center;">{{trans('file.Staff No')}}</label>
                                            <textarea rows="5" class="form-control" name="staff_note"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        <label style="text-align: center;">{{trans('file.Notification')}}</label>
