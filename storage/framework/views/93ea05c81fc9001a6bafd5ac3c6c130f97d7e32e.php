                ...
                <tr data-id="<?php echo e($biller->id); ?>">
                   ...
                   <!--  <td><?php echo e($biller->vat_number); ?></td> -->
                    ...
                    <td><?php echo e($biller->address); ?>
                            ...
                            <?php if($biller->city): ?><?php echo e(', '.$biller->city); ?><?php endif; ?></td>
                    <td>
                        <div class="btn-group">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
           <p><?php echo e(trans('file.The correct column order is')); ?> (name*, image, company_name*,  email*, phone_number*, address*, city*) <?php echo e(trans('file.and you must follow this')); ?>.</p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcmms\resources\views/biller/index.blade.php ENDPATH**/ ?>