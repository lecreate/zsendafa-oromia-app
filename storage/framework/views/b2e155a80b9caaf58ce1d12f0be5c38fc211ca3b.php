...
<script type="text/javascript">
    ...
    function deliveryDetails(delivery, barcode) {
        ...
        var htmlfooter = '<div class="col-md-4 form-group"><p>Authorized by Name and Signature: '+delivery[12]+'</p></div>';
        htmlfooter += '<div class="col-md-4 form-group"><p>Delivered By: '+delivery[13]+'</p></div>';
        htmlfooter += '<div class="col-md-4 form-group"><p>Recieved By: '+delivery[14]+'</p></div>';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcmms\resources\views/delivery/index.blade.php ENDPATH**/ ?>