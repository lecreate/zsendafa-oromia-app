        ...
        <table id="supplier-table" class="table">
            ...
            <tbody>
                ...
                <tr data-id="{{$supplier->id}}">
                    ...
                    <td>{{ $supplier->address}}
                            @if($supplier->city){{ ', '.$supplier->city}}@endif</td>
                    <td>
                        <div class="btn-group">
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
	       <p>{{trans('file.The correct column order is')}} (name*, image, company_name*, vat_number, email*, phone_number*, address*, city*) {{trans('file.and you must follow this')}}.</p>
