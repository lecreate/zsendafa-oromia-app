                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.roffice')); ?>

                                            </label>
                                            <input type="text" name="roffice" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.workpro')); ?>

                                            </label>
                                            <input type="text" name="workpro" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.building')); ?>
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.pin')); ?>

                                            </label>
                                            <input type="text" name="pin" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.rname')); ?>

                                            </label>
                                            <input type="text" name="rname" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.rday')); ?>

                                            </label>
                                            <input type="text" name="rday" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.rnames')); ?>

                                            </label>
                                            <input type="text" name="rnames" class="form-control" />
                                        </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="form-group">
                                            <label>
                                                <?php echo e(trans('file.tn')); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.cause')); ?></label>
                                            <textarea rows="5" class="form-control" name="cause"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(trans('file.rnotification')); ?></label>
                                            <input type="number" name="rnotification">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcmms\resources\views/return/create.blade.php ENDPATH**/ ?>