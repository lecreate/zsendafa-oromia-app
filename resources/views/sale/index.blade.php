...
<section>
    <div class="container-fluid">
        ...
        @if(in_array("sales-add", $all_permission))
            <a href="{{route('sales.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add US')}}</a>&nbsp;
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    <div class="col-md-3">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i class="dripicons-print"></i> {{trans('file.Print')}}
...
<script type="text/javascript">
    ...
    function saleDetails(sale){
        ...
        var htmltext = '<strong>{{trans("file.Date")}}: </strong>'+sale[0]+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong >{{trans("file.reference")}}: </strong>'+sale[1]+'<br><strong>{{trans("file.Warehouse")}}: </strong>'+sale[33]+'<br><strong>{{trans("file.Sale Status")}}: </strong>'+sale[8]+'<br><strong>{{trans("file.won")}}: </strong>'+sale[2]+'<br><strong>{{trans("file.assetout")}}: </strong>'+sale[3]+'<br><strong>{{trans("file.pinp")}}: </strong>'+sale[4]+'<br> <strong >{{trans("file.myname")}} </strong>'+sale[5]+'&nbsp;<strong >{{trans("file.dated")}} </strong>'+sale[6]+'&nbsp;<strong >{{trans("file.issue")}} </strong>'+sale[7]+'&nbsp;<strong >{{trans("file.sign")}} </strong></div><div class="row"><br><div class="col-md-6"><strong>{{trans("file.From")}}:</strong><br>'+sale[9]+'<br>'+sale[10]+'<br>'+sale[11]+'<br>'+sale[12]+'<br>'+sale[13]+'<br>'+sale[14]+'</div><div class="col-md-6"><div class="float-right"><strong>{{trans("file.To")}}:</strong><br>'+sale[15]+'<br>'+sale[16]+'<br>'+sale[17]+'<br>'+sale[18]+'</div></div></div>';
        ...
        var htmlfooter = '<p><strong>{{trans("file.Sale Note")}}</strong> <br>Maqaa:'+sale[29]+'<br> Mallatto:</p><p><strong>{{trans("file.Staff No")}}</strong><br>Maqaa: '+sale[30]+'<br> Mallatto:</p><strong>{{trans("file.Created By")}}:</strong><br>'+sale[31]+'<br>'+sale[32]+'<p><strong>{{trans("file.Notification")}}</strong> ';
