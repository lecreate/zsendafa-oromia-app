            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id="sale-list-menu"><a href="<?php echo e(route('sales.index')); ?>"><?php echo e(trans('file.Sale List')); ?></a></li>
                    ...
                    <li id="sale-create-menu"><a href="<?php echo e(route('sales.create')); ?>"><?php echo e(trans('file.Add US')); ?></a></li>
              ...
              <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-return"></i><span><?php echo e(trans('file.return')); ?></span></a>
                <ul id="return" class="collapse list-unstyled ">
                  ...
                  <li id="sale-return-menu"><a href="<?php echo e(route('return-sale.index')); ?>"><?php echo e(trans('file.Sal')); ?></a></li>
                  <?php endif; ?>
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                  ...
                  <li class="nav-item" id="notification-icon">
                        ...
                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                            ...
                            <?php $__currentLoopData = \Auth::user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="notifications">
                                <a href="<?php echo e(route('notifications.store')); ?>" class="btn btn-link"><?php echo e($notification->data['message']); ?></a>
                                </li>
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                          ...
                          <li>
                            <a href="<?php echo e(url('language_switch/en')); ?>" class="btn btn-link"> Afaan Oromoo</a>
                          </li>
                          <li>
                            <a href="<?php echo e(url('language_switch/en')); ?>" class="btn btn-link">Amharic </a>
                          </li>
                          <!-- <li>
...
</html><?php /**PATH C:\xampp\htdocs\zsendafa-oromia-app\resources\views/layout/main.blade.php ENDPATH**/ ?>