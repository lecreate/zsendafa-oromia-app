    ...
    <div class="table-responsive">
        <table id="delivery-table" class="table">
            ...
            <tbody>
                ...
                ?>
                <tr class="delivery-link" data-barcode="<?php echo e($barcode); ?>" data-delivery='["<?php echo e(date($general_setting->date_format, strtotime($delivery->created_at->toDateString()))); ?>", "<?php echo e($delivery->reference_no); ?>", "<?php echo e($delivery->sale->reference_no); ?>", "<?php echo e($status); ?>", "<?php echo e($delivery->id); ?>", "<?php echo e($delivery->sale->customer->name); ?>", "<?php echo e($delivery->sale->customer->phone_number); ?>", "<?php echo e($delivery->sale->customer->address); ?>", "<?php echo e($delivery->sale->customer->city); ?>", "<?php echo e($delivery->doffice); ?>","<?php echo e($delivery->dname); ?>","<?php echo e($delivery->dwork); ?>", "<?php echo e($delivery->user->name); ?>", "<?php echo e($delivery->delivered_by); ?>", "<?php echo e($delivery->recieved_by); ?>"]'>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-bordered product-delivery-list">
                <thead>
                    <th>lakk</th>
                    <th>moodela ykn seerii qabeenya</th>
                    <th>ibsaa waa'ee qabeenya</th>
                    <th>baayina</th>
                     <th>gatii dimshaashaa</th>
                </thead>
                <tbody>
                </tbody>
            </table>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label><?php echo e(trans('file.Sale Refer')); ?></label>
                        <p id="sr"></p>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                     ...
                     <div class="col-md-6 form-group">
                        ...
                        <!-- <textarea rows="3" name="ask" class="form-control"></textarea> -->
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function deliveryDetails(delivery, barcode) {
        $('input[name="delivery_id"]').val(delivery[7]);
        $("#delivery-content tbody").remove();
        var htmltext = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><?php echo e(trans("file.Date")); ?>:</strong>'+delivery[0]+'<br><strong>&nbsp;&nbsp;<?php echo e(trans("file.doffice")); ?></strong>&nbsp;&nbsp;'+delivery[9]+'<strong>&nbsp;&nbsp;<?php echo e(trans("file.dname")); ?></strong>&nbsp;&nbsp;'+delivery[10]+'<strong>&nbsp;&nbsp;<?php echo e(trans("file.dwork")); ?></strong>&nbsp;&nbsp;'+delivery[11]+'<strong>&nbsp;&nbsp;<?php echo e(trans("file.ask")); ?></strong><br>'+delivery[0]+'';
        var newBody = $("<tbody>");
        var rows = '';
        rows += '<tr><td>Date</td><td>'+delivery[0]+'</td></tr>';
        rows += '<tr><td> Reference</td><td>'+delivery[1]+'</td></tr>';
        ...
        var htmlfooter = '<div class="col-md-4 form-group"><p>Kan gaafate <br>Maqaa: '+delivery[14]+'<br> Mallattoo:</p></div>';
        htmlfooter += '<div class="col-md-4 form-group"><p>Gaafii kan mirkanesse<br>Maqaa:'+delivery[12]+'<br> Mallattoo:</p></div>';
        htmlfooter += '<div class="col-md-4 form-group"><p>Kan akkaa kennamu ajajee<br>Maqaa:'+delivery[13]+'<br> Mallattoo:</p></div>';
        htmlfooter += '<br><br><br><br>';
       
         $('#delivery-content').html(htmltext);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/delivery/index.blade.php ENDPATH**/ ?>