      ...
      <div class="modal-content">
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h3 id="exampleModalLabel" class="modal-title text-center container-fluid"><img src="{{url('public/logo', $general_setting->site_logo)}}" width="30">{{$general_setting->site_title}}</h3>
                </div>
                <div class="col-md-3">
                    <button type="button" id="close-btn" data-dismiss="modal" aria-label="Close" class="close d-print-none"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{trans('file.Transfer Details Info')}}</i>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function transferDetails(transfer) {
        ...
        var htmlfooter = '<p><strong>{{trans("file.transferor")}}:</strong> '+transfer[14]+'<p><strong>{{trans("file.recipient")}}:</strong> '+transfer[15]+'</p><strong>{{trans("file.Created By")}}:</strong><br>'+transfer[16]+'<br>'+transfer[17];
