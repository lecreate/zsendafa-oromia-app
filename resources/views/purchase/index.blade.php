...
<script type="text/javascript">
    ...
    function purchaseDetails(purchase){
        ...
        var htmltext = '<strong>{{trans("file.Date")}}: </strong>'+purchase[0]+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>{{trans("file.reference")}}: </strong>'+purchase[1]+'<br><strong>{{trans("file.Purchase Status")}}:</strong>'+purchase[2]+'<br><strong>{{trans("file.mmhf")}}:</strong>'+purchase[8]+'<br><strong>{{trans("file.lmqgit")}}:</strong>'+purchase[9]+'<br><strong>{{trans("file.lait")}}:</strong>'+purchase[10]+'<br><strong>{{trans("file.lndh")}}:</strong>'+purchase[11]+'<br><strong>{{trans("file.myno")}}</strong>&nbsp;&nbsp;&nbsp;'+purchase[12]+'&nbsp;&nbsp;&nbsp;<strong>{{trans("file.pdate")}}</strong>&nbsp;&nbsp;&nbsp;'+purchase[13]+'&nbsp;&nbsp;&nbsp;<strong>{{trans("file.mynt")}}</strong>&nbsp;&nbsp;&nbsp;'+purchase[14]+'&nbsp;&nbsp;&nbsp;<strong>{{trans("file.tke")}}</strong></div><div class="row"><br><div class="col-md-6"><strong>{{trans("file.To")}}:</strong><br>'+purchase[4]+'<br>'+purchase[5]+'<br>'+purchase[6]+'</div><div class="col-md-6"><div class="float-right"><strong>{{trans("file.From")}}:</strong><br>'+purchase[7]+'<br>'+purchase[15]+'<br>'+purchase[16]+'<br>'+purchase[17]+'<br>'+purchase[18]+'<br>'+purchase[19]+'</div></div></div>';
        ...
        var htmlfooter = '<p><strong>{{trans("file.Note")}}</strong><br>Maqaa:'+purchase[29]+'<br> Mallatto:</p><p><strong>{{trans("file.Staff Note")}}</strong> <br>Maqaa:'+purchase[30]+'<br> Mallatto:</p><strong>{{trans("file.Created By")}}:</strong><br>'+purchase[31]+'<br>'+purchase[32]+'<p><strong>{{trans("file.pnotification")}}:</strong> ';
