                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="invoice_format" class="selectpicker form-control" required>
                                            ...
                                            <option value="gst">Ethiopian GST</option>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\zsendafa-oromia-app\resources\views/setting/general_setting.blade.php ENDPATH**/ ?>