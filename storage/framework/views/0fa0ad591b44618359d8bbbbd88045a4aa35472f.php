                ...
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(trans('file.delete')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                    </tbody>
...
<script type="text/javascript">
    ...
    function purchaseDetails(purchase){
        $("#purchase-details input[name='purchase_id']").val(sale[20]);
        var htmltext = '<strong><?php echo e(trans("file.Date")); ?>: </strong>'+purchase[0]+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><?php echo e(trans("file.reference")); ?>: </strong>'+purchase[1]+'<br><strong><?php echo e(trans("file.Purchase Status")); ?>:</strong>'+purchase[2]+'<br><strong><?php echo e(trans("file.mmhf")); ?>:</strong>'+purchase[8]+'<br><strong><?php echo e(trans("file.lmqgit")); ?>:</strong>'+purchase[9]+'<br><strong><?php echo e(trans("file.lait")); ?>:</strong>'+purchase[10]+'<br><strong><?php echo e(trans("file.lndh")); ?>:</strong>'+purchase[11]+'<br><strong><?php echo e(trans("file.myno")); ?></strong>&nbsp;&nbsp;&nbsp;'+purchase[12]+'&nbsp;&nbsp;&nbsp;<strong><?php echo e(trans("file.pdate")); ?></strong>&nbsp;&nbsp;&nbsp;'+purchase[13]+'&nbsp;&nbsp;&nbsp;<strong><?php echo e(trans("file.mynt")); ?></strong>&nbsp;&nbsp;&nbsp;'+purchase[14]+'&nbsp;&nbsp;&nbsp;<strong><?php echo e(trans("file.tke")); ?></strong></div><div class="row"><br><div class="col-md-6"><strong><?php echo e(trans("file.To")); ?>:</strong><br>'+purchase[4]+'<br>'+purchase[5]+'<br>'+purchase[6]+'</div><div class="col-md-6"><div class="float-right"><strong><?php echo e(trans("file.From")); ?>:</strong><br>'+purchase[7]+'<br>'+purchase[15]+'<br>'+purchase[16]+'<br>'+purchase[17]+'<br>'+purchase[18]+'<br>'+purchase[19]+'</div></div></div>';
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Note")); ?></strong><br>Maqaa:'+purchase[29]+'<br> Mallatto:</p><p><strong><?php echo e(trans("file.Staff Note")); ?></strong> <br>Maqaa:'+purchase[30]+'<br> Mallatto:</p><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+purchase[31]+'<br>'+purchase[32]+'<p><strong><?php echo e(trans("file.pnotification")); ?>:</strong> ';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sendafa-oromia-app\resources\views/purchase/index.blade.php ENDPATH**/ ?>