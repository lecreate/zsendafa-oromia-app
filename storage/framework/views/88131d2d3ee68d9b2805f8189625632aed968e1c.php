        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <label>Model 20.</label>
                </div>
                <div class="col-md-6">
                    <h3 id="exampleModalLabel" class="modal-title text-center container-fluid"><img src="<?php echo e(url('public/logo', $general_setting->site_logo)); ?>" width="30"><?php echo e($general_setting->site_title); ?></h3>
                </div>
                <div class="col-md-3">
                    <button type="button" id="close-btn" data-dismiss="modal" aria-label="Close" class="close d-print-none"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                </div>
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(trans('file.Transfer Details Info')); ?></i>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function transferDetails(transfer) {
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.transferor")); ?>:</strong> '+transfer[14]+'<p><strong><?php echo e(trans("file.recipient")); ?>:</strong> '+transfer[15]+'</p><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+transfer[16]+'<br>'+transfer[17];
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcmms\resources\views/transfer/index.blade.php ENDPATH**/ ?>