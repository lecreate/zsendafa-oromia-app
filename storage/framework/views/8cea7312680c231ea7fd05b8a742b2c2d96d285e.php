...
<script type="text/javascript">
    ...
    function returnDetails(returns){
        ...
        var htmlfooter = '<p><strong><?php echo e(trans("file.Return Note")); ?>:</strong> '+returns[29]+'</p><p><strong><?php echo e(trans("file.Staff Note")); ?>:</strong> '+returns[30]+'</p><p><strong><?php echo e(trans("file.rnotification")); ?>:</strong> '+returns[31]+'<br><strong><?php echo e(trans("file.Created By")); ?>:</strong><br>'+returns[32]+'<br>'+returns[33];
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bcmms\resources\views/return/index.blade.php ENDPATH**/ ?>