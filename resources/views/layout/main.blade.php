            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span>{{trans('file.Sale')}}</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id="sale-list-menu"><a href="{{route('sales.index')}}">{{trans('file.Sale List')}}</a></li>
                    ...
                    <li id="sale-create-menu"><a href="{{route('sales.create')}}">{{trans('file.Add US')}}</a></li>
              ...
              <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-return"></i><span>{{trans('file.return')}}</span></a>
                <ul id="return" class="collapse list-unstyled ">
                  ...
                  <li id="sale-return-menu"><a href="{{route('return-sale.index')}}">{{trans('file.Sal')}}</a></li>
                  @endif
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                  ...
                  <li class="nav-item" id="notification-icon">
                        ...
                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                            ...
                            @foreach(\Auth::user()->unreadNotifications as $key => $notification)
                                <li class="notifications">
                                <a href="{{route('notifications.store')}}" class="btn btn-link">{{ $notification->data['message'] }}</a>
                                </li>
                            @endforeach
                        </ul>
                  </li>
                ...
                <li class="nav-item">
                      ...
                      <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                          ...
                          <li>
                            <a href="{{ url('language_switch/en') }}" class="btn btn-link"> Afaan Oromoo</a>
                          </li>
                          <li>
                            <a href="{{ url('language_switch/en') }}" class="btn btn-link">Amharic </a>
                          </li>
                          <!-- <li>
